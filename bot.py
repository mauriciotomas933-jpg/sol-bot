...
# ── CoinGecko: historial de precios SOL (sin restricción geográfica) ───────────
def get_closes():
    # Últimas ~100 velas de 5 minutos = ~500 minutos = ~9 horas en segundos
    url = "https://api.coingecko.com/api/v3/coins/solana/market_chart"
    params = {
        "vs_currency": "usd",
        "days": "1",          # último día
        "interval": "hourly"  # datos horarios (gratis, sin key)
    }
